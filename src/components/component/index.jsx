...
const suitupable = (listenScreen = true, listenSettings = true) => Child => {
    class Component extends React.Component {
        ...
        componentDidMount() {
            if (listenScreen) this.screenListener = Screen.onScreenChange(this.onScreenChange);
            if (listenSettings) this.settingsListener = Settings.onSettingsChange(this.onSettingsChange);
        }
