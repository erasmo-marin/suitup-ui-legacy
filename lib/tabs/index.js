...
var Tabs = (_dec = (0, _component2.default)(true, true), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ['children', 'style', 'indicatorColor', 'screen', 'settings']);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('div', { className: 'active-tab-indicator', style: indicatorStyle })
                ),
                activeTab
            );
        }
    ...
    this.onTabClick = function (tab, index) {
        if (tab == _this3.state.activeTab) return;
