    ...
    _createClass(Box, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ["verticalExpand", "horizontal", "vertical", "autoFill", "centered", "justify", "align", "children", "columns", "gutter", "screen", "style", "settings", "className"]);

            if (!gutter) {
                gutter = "0.5rem";
            }

            var classesObj = _defineProperty({
                "box": true,
            ...
            if (className) {
                ...
                (0, _forEach2.default)(propClasses, function (theClass) {
            ...
            return _react2.default.createElement(
                "div",
                _extends({}, rest, { style: _extends({}, cstyle, style), className: classes }),
