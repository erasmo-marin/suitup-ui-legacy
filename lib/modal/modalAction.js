...
var ModalAction = (0, _component2.default)(_class = function (_React$Component) {
    ...
    _createClass(ModalAction, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ["text", "onClick", "start", "end", "screen"]);
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(ModalAction, "ModalAction", "src/components/modal/modalAction.jsx");

    __REACT_HOT_LOADER__.register(_default, "default", "src/components/modal/modalAction.jsx");
}();
