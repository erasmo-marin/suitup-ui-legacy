...
class Modal extends React.Component {
  ...
  renderModal(props) {
    ...
    let _props = this.props,
        { children, onHide, onShow, onChange, visible } = _props,
    ...
    return React.createElement(
      'div',
      _extends({}, rest, { className: classes, ref: c => this.modal = c, onClick: this.hide }),
      React.createElement(
        'div',
        { className: 'modal', ref: c => this.modalInner = c, style: { position: "relative" }, onClick: this.preventPropagation },
