...
var Image = (_dec = (0, _reactInviewJs2.default)({ fullElementInView: false }), _dec2 = (0, _component2.default)(true, true), _dec(_class = _dec2(_class = function (_React$Component) {
    ...
    function Image(props) {
        ...
        _this.firstLoadVisible = function () {
            return _this.image && _this.image.offsetTop <= window.innerHeight;
        };
    ...
    _createClass(Image, [{
        ...
        value: function recalculeSize() {
            ...
            var pwidth = (0, _isObject3.default)(this.props.width) ? this.props.width[screen] : this.props.width;
            var pheight = (0, _isObject3.default)(this.props.height) ? this.props.height[screen] : this.props.height;
        ...
        value: function computeSizeInPixels(size, axis) {
            ...
            var width = (0, _get2.default)(this.image, "offsetWidth") || 0;
            var height = (0, _get2.default)(this.image, "offsetHeight") || 0;
