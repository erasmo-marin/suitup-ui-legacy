...
var ModalMountController = function (_EventEmitter) {
    ...
    _createClass(ModalMountController, [{
        ...
        value: function requestModalUpdate(component) {
            this.modals[(0, _findIndex3.default)({ key: component.key }, this.modals)] = component;
            this.emitChange(this.modals);
        }
    }, {
        key: "requestModalUnmount",
        value: function requestModalUnmount(component) {
            this.modals = (0, _without3.default)(component, this.modals);
            this.emitChange(this.modals);
        }
    }, {
        key: "emitChange",
...
var Layout = (_dec = (0, _component2.default)(true, true), _dec(_class = function (_React$Component) {
