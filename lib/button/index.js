    ...
    _createClass(Button, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = _objectWithoutProperties(_props, ['primary', 'primaryDark', 'primaryLight', 'accent', 'flat', 'raised', 'inverted', 'text', 'disabled', 'fullWidth', 'children', 'transparent', 'circular', 'rounded', 'menu', 'pressed', 'type', 'onClick', 'onMouseUp', 'onMouseDown', 'floating', 'screen', 'settings']);
