...
var Slider = (_dec = (0, _component2.default)(true, true), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(Slider, [{
        ...
        value: function render() {
            ...
            var _state = this.state,
                slidesSpacing = _state.slidesSpacing,
                displayItems = _state.displayItems,
                centerMode = _state.centerMode,
                centerModePadding = _state.centerModePadding,
                showArrows = _state.showArrows,
                arrowSize = _state.arrowSize,
                lazyLoad = _state.lazyLoad,
                activeIndex = _state.activeIndex,
                minimalRender = _state.minimalRender,
                alreadyLoaded = _state.alreadyLoaded;
            ...
            var slideStyle = {
                width: "calc(" + 100 / (this.props.children.length * displayItems) + "% - " + parseInt(slidesSpacing) + "px)",
            ...
            return _react2.default.createElement(
                ...
                showArrows ? [_react2.default.createElement(
                    "div",
                    {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.props.children.map(function (child, index) {
                                ...
                                var shouldRenderChild = !lazyLoad || lazyLoad && Math.abs(activeIndex - index) < displayItems + 1;
                                ...
                                return _react2.default.createElement(
                                    ...
                                    shouldRenderChild || alreadyLoaded[index] ? child : null
                                );
                            })
                        )
                    )
    ...
    this.loadSettings = function (settings) {
        if (!settings) return;
        _this3.state = _extends({}, _this3.state, settings);
    };
    ...
    this.previous = function () {
        ...
        var slideStep = _this3.state.slideStep;

        if (active - slideStep < 0) {
            if (slideStep === 1) active = _this3.props.children.length - 1;else active = 0;
        } else {
    ...
    this.next = function () {
        ...
        if (active > _this3.props.children.length - slideStep - 1) {
            if (slideStep === 1) active = 0;else active = _this3.props.children.length - 1;
        } else {
            active = active + slideStep;
        }
        _this3.goTo(active);
    ...
    this.goTo = function (index) {
        ...
        if (index > _this3.props.children.length - 1) {
            index = _this3.props.children.length - 1;
        }

        _this3.draggableContent.style.transition = "all 0.5s ease-in-out";
        var dw = _this3.draggableContent.offsetWidth;
        var sw = dw / _this3.props.children.length;

        var x = sw * index * -1 / displayItems;

        var maxX = (sw * (_this3.props.children.length - 1) - sw * (displayItems - 1)) / displayItems;
        ...
        _this3.draggableComponent.setState({
            x: x
        });
    ...
    this.onEndDrag = function (event) {
        var displayItems = _this3.state.displayItems;

        var x = -1 * _this3.draggableComponent.state.x;
        var dw = _this3.draggableContent.offsetWidth;
        var sw = dw / _this3.props.children.length / displayItems;
    ...
    this.onUserNext = function () {
        _this3.stopAutoPlay();
        _this3.next();
    };

    this.onUserPrevious = function () {
        _this3.stopAutoPlay();
        _this3.previous();
    };
}, _temp)) || _class);
