...
var Slider = (_dec = (0, _component2.default)(true, true), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(Slider, [{
        ...
        value: function render() {
            ...
            var _state3 = this.state,
                nextArrow = _state3.nextArrow,
                prevArrow = _state3.prevArrow;
            ...
            return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            (0, _concat2.default)(this.rightClonedItems, this.props.children, this.leftClonedItems).map(function (child, index) {
                                ...
                                return shouldRenderSlide ? _react2.default.createElement(
                                    ...
                                    child
                                ) : _react2.default.createElement('div', { style: slideStyle, key: currentIndex });
                            })
                        )
                    )
                ),
                this.state.showDots ? _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _box2.default,
                            { horizontal: true, columns: this.props.children.length, gutter: '0' },
        ...
        get: function get() {
            var _state4 = this.state,
                _state4$displayItems = _state4.displayItems,
                displayItems = _state4$displayItems === undefined ? 1 : _state4$displayItems,
                _state4$centerMode = _state4.centerMode,
                centerMode = _state4$centerMode === undefined ? false : _state4$centerMode,
                _state4$infinite = _state4.infinite,
                infinite = _state4$infinite === undefined ? false : _state4$infinite;
    ...
    this.onEndDrag = function (event) {
        ...
        var _state8 = _this3.state,
            ...
            infinite = _state8.infinite,
            slideStep = _state8.slideStep,
            animationTime = _state8.animationTime;
        var children = _this3.props.children;
    ...
    this.shouldRenderSlide = function (currentIndex, index) {
        var _state9 = _this3.state,
            activeIndex = _state9.activeIndex,
            lazyLoad = _state9.lazyLoad,
            displayItems = _state9.displayItems,
            itemsToClone = _state9.itemsToClone;
